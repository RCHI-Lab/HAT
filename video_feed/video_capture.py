...
save_video_depth = False 
save_video_colorAndDepth = False # color and depth concatenated side-by-side
...
fps_color = 15 # FPS for color-only videos and for color+depth videos
